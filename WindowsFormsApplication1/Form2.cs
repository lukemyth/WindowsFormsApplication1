...
/*
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                label57.Text = ("提示:" + ST_name.Text + "数据添加成功！");                          
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlcmd.ExecuteNonQuery();
                label57.Text = ("提示:" + ST_name.Text + "数据修改成功！");
                SqlDataAdapter sda1 = new SqlDataAdapter("select ST_name as '姓名',ST_sex as '性别',ST_race as '民族',ST_birth as '出生年月',ST_jiguan as '籍贯',ST_major as '专业',ST_Num as '证件号',ST_PreSchool as '所属班排',ST_IDNum as '身份证号',ST_polID as '政治面貌',ST_isonlychild as '职务',ST_QorS as '干部/士兵/义务兵',ST_address as '现居住地',ST_experience as '个人经历', from ST_Information ", conn);
                DataSet ds1 = new DataSet();
                sda1.Fill(ds1, "emp");
                dataGridView1.DataSource = ds1.Tables[0];
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.SelectedCells.Count != 0)
            {
                ...
                try
                {
                    ...
                    SqlConnection conn = new SqlConnection("server=" + ipAdress + ";database=ErYingDatabase; uid=sa; pwd=9876543q");
                    conn.Open();
                    str ="select*from LeaveBack where  ST_Num = '" + dataGridView1.CurrentRow.Cells[1].Value.ToString()+"' and RBackTime is null";
...

        {
          ...
          string str0= " ST_Num='" + ST_Num.Text.Trim() + "'";
            ...
            try
            {
                ...
                label57.Text = ("提示:" + ST_name.Text + "数据删除成功！");
        ...
        ////    {
        ////        sqlcmd.ExecuteNonQuery();
        ////        label57.Text = ("提示:学号为" + dataGridView2 .CurrentCell .Value .ToString ()+ ""+ST_terms.Text +"学期"+ST_subject.Text +"成绩删除成功！");
        ////        StudyTraining();
        ////        SetGradesColor();
        ////    }
        ////    catch (Exception ex)
        ...
        private void AddUpdateData()
        {
            ...
            try
            {
                ...
                sqlcmd.ExecuteNonQuery();
                label57.Text = ("提示:人员 " + ST_name.Text + " 的数据添加成功！");
                object sender1 = new object(); EventArgs e0 = new EventArgs();
                button2_Click(sender1, e0);
            ...
            catch
            {
                ...
                {
                    sqlcmd.ExecuteNonQuery();
                    label57.Text = ("提示:人员 " + ST_name.Text + " 的数据修改成功！");
                    object sender1 = new object();EventArgs e0 = new EventArgs();
                    button2_Click(sender1   , e0);
            ...
            try
            {
                ...
                catch
                {
                    try
                    {
                        ...
                        sqlcmd1.Parameters.Add("@imagelist", SqlDbType.Image).Value = imagebytes;
                        string str = "update ST_Photos set ST_photo=@imagelist where ST_Num='" + ST_Num.Text.Trim() + "'";
                        sqlcmd1.CommandText = str ;
                        
                        //SqlParameter param = new SqlParameter("@imagelist", SqlDbType.VarBinary, imageBytes.Length);
                        //param.Value = imageBytes;
                        //sqlcmd1.Parameters.Add(param);
                        //sqlcmd1.Parameters["imagelist"].Value = ;
                        int k=sqlcmd1.ExecuteNonQuery();
                        if (k == 1)
                        {
                            label57.Text += "照片修改成功！";
                        }
        ...
        public void SetLeaveBack()
        {
            ...
            for (int i=0;i<data .Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (int.Parse (data.Rows[i][8].ToString () )< 3)
                    {
                        counting++;
                    }
        ...
        public void LeaveWarning()
        {
            if (LeaveNum != 0)
            {
                MessageBox.Show("目前有" + LeaveNum + "名同志将要归队！");
            }
        }
